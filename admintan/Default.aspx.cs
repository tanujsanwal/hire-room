...
public partial class admintan_Default : System.Web.UI.Page
{
    SqlConnection conn;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        comm.CommandText = "Select * from admin where email=@em and password=@ps";
